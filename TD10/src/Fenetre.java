...
public class Fenetre extends Canvas {
	...
	public Fenetre() {
		...
		frame.addWindowListener(new INF411WindowAdapter());
		frame.addComponentListener(new INF411ComponentAdapter(this));
...
class INF411WindowAdapter extends WindowAdapter {
	public void windowClosing(WindowEvent e) {
		System.exit(0);
	}
}

class INF411ComponentAdapter extends ComponentAdapter {
	Fenetre f;
	
	INF411ComponentAdapter (Fenetre f) {
		this.f = f;
	}
	
    public void componentMoved(ComponentEvent componentEvent) {
		// Ici on pourrait redessiner lq fenêtre, mais c'est plus compliqué que cela ne
		// paraît
    }
}